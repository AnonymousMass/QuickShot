...
namespace GIFBuilder
{
    public partial class GIFBuilderUI : Form
    {
        ...
        {
            MessageBox.Show("GIF 图片生成成功！", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
            ToggleButtons(true);
        }
        ...
        private void cmdBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                openFileDlg.Filter = "支持格式|*.jpg;*.png;*.jpeg;*.bmp";
        ...
        private void cmdBuild_Click(object sender, EventArgs e)
        {
            ...
            string FileName = "GIF" + time.Date.ToShortDateString().Replace("/", "") + "_" + time.ToLongTimeString().Replace(":", "");
            ...
            using (SaveFileDialog saveDialog = new SaveFileDialog())
            {
                ...
                saveDialog.FileName = FileName+".gif";
                saveDialog.Title = "保存GIF格式的图片 - GIF 生成器";
        ...
        private void GIFBuilderUI_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void GIFBuilderUI_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;
        }

        private void GIFBuilderUI_FormClosing(object sender, FormClosingEventArgs e)
        {
            GC.Collect(0, GCCollectionMode.Forced);
        }
